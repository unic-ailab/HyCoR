...
class calcMetric(object):
    ...
    def calcDropout(train_acc,test_acc,base_dropout,_count):
        ...
        if   overfit_factor > 0.5:
            _count +=1
            return base_dropout * 0.5,_count
        if   overfit_factor > 0.4:
            _count+=1
            return base_dropout * 0.6,_count
        if   overfit_factor > 0.3:
            _count+=1
            return base_dropout * 0.7,_count
        elif overfit_factor > 0.2:
            _count+=1
            return base_dropout * 0.8,_count
        elif overfit_factor > 0.1:
            _count=0
            return base_dropout * 0.9,_count
        else :
            _count=0
            return base_dropout,_count
